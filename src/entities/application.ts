...
export interface IApplication {
  ...
  st?: number; // meta
  acct?: AddressString;
  // cTopPriv?: AuthorizationPrivilege; // minimum privilege needed to create topics within the app
  dAuthPriv?: AuthorizationPrivilege; // default privilege assigned to anyone that joins app by authorizing an agent
